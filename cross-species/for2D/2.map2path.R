...
bp <- gmtPathways("../gmtdata/c5.go.bp.v7.4.symbols.gmt")
mf <- gmtPathways("../gmtdata/c5.go.mf.v7.4.symbols.gmt")
cc <- gmtPathways("../gmtdata/c5.go.cc.v7.4.symbols.gmt")

kegg <- gmtPathways("../gmtdata/c2.cp.kegg.v7.4.symbols.gmt")
...
save(human_rank, mouse_rank, file = "ranks.Rdata")
...
save(map_fin, file = "gene2sets_10cut.Rdata")