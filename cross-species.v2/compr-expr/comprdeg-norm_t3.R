...
## normed read count
human_exp_normed <- read.table("../diff-expr/human_normed_count_t3.tsv")
...
for(i in 1:length(plot_dat)) {
    ...
    ggsave(width = 7.6, height = 7.6, filename = paste0(names(plot_dat[i]), "_normed_up_t3.png"), path = "../figs/t3_boxplot/normed-deg_boxplot")
...
for(i in 1:length(plot_dat)) {
    ...
    ggsave(width = 7.6, height = 7.6, filename = paste0(names(plot_dat[i]), "_normed_dn_t3.png"), path = "../figs/t3_boxplot/normed-deg_boxplot")
}
