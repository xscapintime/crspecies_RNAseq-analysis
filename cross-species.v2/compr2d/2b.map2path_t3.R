...
## diapause gene set
load("diapuse_set_t3.Rdata")

diapuse_set <- diapuse_set_t3 # easy name


### DEG table
## DESeq2 results
human_res <- read.table("../diff-expr/human_deg_t3.tsv")
mouse_res <- read.table("../diff-expr/mouse_deg_t3.tsv")
...
save(human_rank, mouse_rank, file = "ranks_t3.Rdata")
...
save(map, file = "gene2sets_t3.Rdata")
...
save(map_fin, file = "gene2sets_10cut_t3.Rdata")